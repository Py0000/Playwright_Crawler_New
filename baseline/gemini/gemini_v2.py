...
class GeminiPromptGenerator:
    ...
    def generate_zero_shot_prompt(self):
        ...
        mode_files = {
            GeminiProBaseline.MODE_BOTH: ("system_prompt_both.txt", "response_format_prompt.txt", "chain_of_thought_prompt_both.txt"),
            GeminiProBaseline.MODE_SCREENSHOT: ("system_prompt_ss.txt", "response_format_prompt.txt", "chain_of_thought_prompt_ss.txt"),
