...
if __name__ == '__main__':
    ...
    parser.add_argument("phishing_or_benign_tag", help="Name of the folder that contains the dataset")
    args = parser.parse_args()

    dataset_folder_name = os.path.join(args.phishing_or_benign_tag, f"{util_def.FOLDER_DATASET_BASE}")
    analyzed_data_folder_name = os.path.join(args.phishing_or_benign_tag, f"{util_def.FOLDER_ANALYSIS_BASE}")

    extract_and_analyse(dataset_folder_name, analyzed_data_folder_name, ref_flag=True)
    extract_and_analyse(dataset_folder_name, analyzed_data_folder_name, ref_flag=False)
    analysis_page_for_differences(dataset_folder_name, analyzed_data_folder_name)